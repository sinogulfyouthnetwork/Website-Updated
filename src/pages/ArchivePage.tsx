        ...
        <header className="sticky top-0 z-50"
          ...
          <div className="max-w-6xl mx-auto px-6 lg:px-10 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2.5">
              <img src="logo.png" alt="SGYN" className="h-6 w-auto" style={{ filter: 'brightness(0) sepia(1) hue-rotate(170deg) saturate(3)' }} />
              <span style={{ fontFamily: "'Playfair Display', serif", fontWeight: 600, fontSize: '0.9rem', color: '#1a3a52' }}>
                Media Lab
              </span>
            </div>
