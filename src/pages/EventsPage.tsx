...
type EventTheme = 'Cultural Exchange' | 'Youth Diplomacy' | 'Language Exchange' | 'Literary Salon' | 'Networking' | 'Academic' | 'Diplomatic' | 'Lab';
...
const events: SGYNEvent[] = [
  {
    ...
    description: 'The inaugural SGYN event -— a cultural evening that brought together international, Chinese, and Emirati students in the Shanghai community for an evening of cultural exchange and connection. Supported by NYU Shanghai, NYU Abu Dhabi Global Outreach, and H.E UAE Ambassador Hussain Alhammadi.',
    partners: ['NYU Shanghai', 'NYU Abu Dhabi', 'UAE Consulate'],
    cover: 'ChinaEmaritiEventImg/ChinaEmaritiEvent2.jpeg',
    photos: [
      'ChinaEmaritiEventImg/ChinaEmaritiEvent1.jpeg',
      'ChinaEmaritiEventImg/ChinaEmaritiEvent2.jpeg',
      'ChinaEmaritiEventImg/ChinaEmaritiEvent3.jpg',
      'ChinaEmaritiEventImg/ChinaEmaritiEvent4.jpg',
      'ChinaEmaritiEventImg/ChinaEmaritiEvent5.JPG',
      'ChinaEmaritiEventImg/ChinaEmaritiEvent6.JPG',
      'ChinaEmaritiEventImg/ChinaEmaritiEvent7.JPG',
      'ChinaEmaritiEventImg/ChinaEmaritiEvent8.JPG',
      'ChinaEmaritiEventImg/ChinaEmaritiEvent9.JPG',
      'ChinaEmaritiEventImg/ChinaEmaritiEvent10.JPG',
    ],
  },
  {
    id: 'chinese-saudi-jeddah-2025',
    number: 2,
    title: 'Chinese-Saudi Cultural Exchange Evening: 中沙之夜',
    subtitle: '中沙之夜',
    location: 'Jeddah, KSA',
    venue: 'Qanateer',
    date: 'August 16, 2025',
    theme: 'Cultural Exchange',
    description: 'SGYN brought to Jeddah the first ever youth-led Chinese-Saudi cultural exchange evening, hosted at Qanateer. From cultural demonstrations to panelists talking about life in China, this marked the beginning of a new chapter in youth-led bilateral engagement in KSA.',
    partners: ['Qanateer', 'House of Wisdom'],
    cover: 'QanateerImg/Qanateeer7.jpg',
    photos: [
      'QanateerImg/QanateerEvent1.JPG',
      'QanateerImg/Qanateer2.JPG',
      'QanateerImg/Qanateer3.JPG',
      'QanateerImg/Qanateer4.JPG',
      'QanateerImg/Qanateer5.JPG',
      'QanateerImg/Qanateer6.JPG',
      'QanateerImg/Qanateeer7.jpg',
      'QanateerImg/Qanateer8.JPG',
      'QanateerImg/Qanateer9.j[g',
    ],
  },
  {
    id: 'literary-salon-1-jeddah-2025',
    number: 3,
    title: 'Literary Salon: Mid-Autumn Festival (Session 1)',
    location: 'Jeddah, KSA',
    venue: 'Al Maqam Cafe',
    date: 'October 10, 2025',
    theme: 'Literary Salon',
    description: 'The first of our Jeddah Literary Salon series, celebrating the Mid-Autumn Festival through a reading of the famous poem, “Prelude to Water Melody” by Su Shi and mooncakes. Hosted by Al-Maqam cafe, it was an intimate gathering exploring poetry and the art of translation. ',
    partners: ['Al Maqam Cafe'],
    cover: 'OctLitSalonImg/OctLitSalon5.jpg',
    photos: [
      'OctLitSalonImg/OctLitSalon1.jpg',
      'OctLitSalonImg/OctLitSalon2.jpg',
      //'OctLitSalonImg/OctLitSalon3.jpg',
      'OctLitSalonImg/OctLitSalon4.jpg',
      'OctLitSalonImg/OctLitSalon5.jpg',
    ],
  },
  {
    id: 'sgyn-launch-beijing-2025',
    number: 4,
    title: 'SGYN Beijing Launch',
    location: 'Beijing, China',
    venue: 'Al-Khaleej Mandi Kitchen',
    date: 'November 8, 2025',
    theme: 'Networking',
    description: 'SGYN officially launched its presence in Beijing with a private networking lunch in Sanlitun. hosting international scholars from Peking and Tsinghua university, as well as other guests from the China-Gulf community.',
    partners: ['UAE Embassy Beijing'],
    participants: 62,
    tag: 'Launch',
    cover: 'BeijingLaunchImg/BeijingLaunch6.JPG',
    photos: [
      'BeijingLaunchImg/BeijingLaunch1.JPG',
      'BeijingLaunchImg/BeijingLaunch2.JPG',
      'BeijingLaunchImg/BeijingLaunch3.JPG',
      'BeijingLaunchImg/BeijingLaunch4.JPG',
      'BeijingLaunchImg/BeijingLaunch5.JPG',
      'BeijingLaunchImg/BeijingLaunch6.JPG',
    ],
  },
  {
    ...
    date: 'November 2025',
    theme: 'Diplomatic',
    description: 'SGYN led an UAE National Day celebration at the Yenching Academy of Peking University, one of China’s most prestigious international academic institutions. Yenching Scholars learned about the UAE’s cultural identity and formation, and took part in celebrating the nation’s rich heritage.',
    partners: ['UAE Embassy Beijing', 'Yenching Academy (Peking University)'],
    //participants: 34,
    cover: 'UAE_National_Day_3.png',
    photos: [
  ...
  },
  {
    ...
    number: 6,
    title: 'Sino-Gulf Youth Dialogue: Uniting Youth Voices ',
    location: 'New York City, USA',
    venue: 'UAE Permanent Mission to the United Nations',
    date: 'November 19, 2025',
    theme: 'Diplomatic',
    description: 'Co-hosted with the UAE Youth Society and the UAE Youth Delegates the United Nations, the Sino-Gulf Youth Dialogue convened over a hundred youth leaders, scholars, artists, and diplomats from China and the Gulf to shape the next chapter of bilateral cooperation. ',
  ...
  },
  {
    ...
    number: 7,
    title: 'ECUST UAE National Day Celebration',
    location: 'Shanghai, China',
    venue: 'East China University of Science and Technology',
    date: 'November 30, 2025',
    theme: 'Diplomatic',
    description: 'SGYN was invited to represent at East China University of Science and Technology’s UAE National Day celebration, co-attended with the UAE Consulate in Shanghai. The evening of celebration strengthened ties between the university community and Gulf diplomatic presence in China.',
  ...
  },
  {
    ...
    partners: ['Al Maqam Cafe'],
    cover: 'DecLitSalon/DecLitSalon1.JPG',
    photos: [
      'DecLitSalon/DecLitSalon1.JPG',
      'DecLitSalon/DecLitSalon2.JPG',
    ],
  },
  {
    id: 'lab-jeddah-2026',
    number: 9,
    title: 'Lab Across Borders: Jeddah',
    location: 'Jeddah, KSA',
    venue: 'Al Maqam Cafe',
  ...
  },
  {
    id: 'lab-khobar-2026',
    number: 10,
    title: 'Lab Across Borders: Khobar',
    location: 'Dammam / Khobar, KSA',
    venue: 'KoYee Korean Cafe & Cuisine',
    date: 'January 31, 2026',
    theme: 'Lab',
    description: 'The second LAB session in Saudi Arabia, connecting local Arabic, Chinese, and Korean speakers through language, conversation, and community. ',
    partners: ['KoYee Korean Cafe & Cuisine'],
    participants: 25,
    cover: 'LAB_Khobar_3.jpg',
    photos: [
      'LAB_Khobar_1.JPG',
      'LAB_Khobar_2.jpg',
      'LAB_Khobar_3.jpg',
    ...
    date: 'December 2025',
    theme: 'Cultural Exchange',
    description: 'SGYN attended the KFUPM World celebrations at King Fahd University of Petroleum and Minerals, visiting the Countries Expo to learn Dragon Dance and engage in other cultural workshops.',
    partners: ['KFUPM'],
    cover: 'KFUPMWorld/KFUPM2.jpg',
    photos: [
      'KFUPMWorld/KFUPM1.jpg',
      'KFUPMWorld/KFUPM2.jpg',
      'KFUPMWorld/KFUPM3.jpg',
    ],
  },
];
